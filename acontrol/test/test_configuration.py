...
class ConfigurationTestCase(TestWithConfig):
    ...
    def test_server(self):
        ...
        self.assertEqual(cmd, ('imaging-server', u'10.195.100.30', 45000, '--buffer-max-size 64424509440 --input-port-start 4100 --input-host 10.195.100.3 --stream 63 295 --stream 63 296 --stream 63 297 --stream 63 298 --stream 63 300 --stream 63 301 --stream 63 302 0-62'))


    def test_pipeline(self):
        cmd = self.config.pipelines(self.obs)
        self.assertEqual(cmd, [('imaging-pipeline', u'10.144.6.16', 45000, '--vis-sigma 3 --antenna-positions /home/fhuizing/soft/release/share/aartfaac/antennasets/lba_outer.dat --ant-sigma 4 --casa /data/20150202-2247 --server-host 10.195.100.30'), ('imaging-pipeline', u'10.144.6.17', 45000, '--vis-sigma 3 --antenna-positions /home/fhuizing/soft/release/share/aartfaac/antennasets/lba_outer.dat --ant-sigma 4 --casa /data/20150202-2247 --server-host 10.195.100.30'), ('imaging-pipeline', u'10.144.6.18', 45000, '--vis-sigma 3 --antenna-positions /home/fhuizing/soft/release/share/aartfaac/antennasets/lba_outer.dat --ant-sigma 4 --casa /data/20150202-2247 --server-host 10.195.100.30'), ('imaging-pipeline', u'10.144.6.19', 45000, '--vis-sigma 3 --antenna-positions /home/fhuizing/soft/release/share/aartfaac/antennasets/lba_outer.dat --ant-sigma 4 --casa /data/20150202-2247 --server-host 10.195.100.30'), ('imaging-pipeline', u'10.144.6.20', 45000, '--vis-sigma 3 --antenna-positions /home/fhuizing/soft/release/share/aartfaac/antennasets/lba_outer.dat --ant-sigma 4 --casa /data/20150202-2247 --server-host 10.195.100.30')])
